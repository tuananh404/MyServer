...
repository. SDK V2 includes one Android platform file, universal static native
archives for ARM64/ARMv7, headers, ndk-build/CMake helpers, the installer,
documentation, the generated manifest, and `GeneratedConnection.java`
...
The loaded native library must link `libserverkey_core.a` with whole-archive.
Use `serverkey-prebuilt.mk` for ndk-build or call
